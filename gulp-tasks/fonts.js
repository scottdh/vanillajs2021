...
const fonts = async () => {
  ...
  const result = await instance.download(
    "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&display=swap&family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&display=swap"
  );
